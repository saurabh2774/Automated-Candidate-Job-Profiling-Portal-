...
const Footer = () => {
  return (
    <footer className="w-full py-8 bg-black/90 text-gray-300 border-t border-purple-900/30">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <Link href="/" className="flex items-center">
            ...
            <p className="text-sm text-gray-400 mb-4">
              Find your dream job with our intelligent job hunting platform
            </p>
            <div className="flex space-x-4">
              <a href="#" className="text-gray-400 hover:text-[#63e]">
